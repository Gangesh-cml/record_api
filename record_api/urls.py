...
# from record_api.views import recordViewSet
...
from record_api import views
urlpatterns = [
    path('records/', RecordListCreateView.as_view(), name='record list create'),
    path('records/<int:pk>', RecordRetrieveUpdateDeleteView.as_view(), name='record list create')
]